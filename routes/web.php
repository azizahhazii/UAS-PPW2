...
Route::prefix('/pekerjaan')->group(function () {
    ...
    Route::put('update/{id}', [App\Http\Controllers\PekerjaanController::class, 'update'])->name('pekerjaan.update');    Route::delete('delete', [App\Http\Controllers\PekerjaanController::class, 'destroy'])->name('pekerjaan.destroy');
});
...
Route::prefix('/pegawai')->group(function () {
    ...
    Route::put('/update', action: [App\Http\Controllers\PegawaiController::class, 'update'])->name('pegawai.update');
    Route::delete('/delete', action: [App\Http\Controllers\PegawaiController::class, 'destroy'])->name('pegawai.destroy');
});
